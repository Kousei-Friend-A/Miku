...
api_id = int(os.environ.get("17945796"))
api_hash = os.environ.get("4a05481a5da2d66f801acffc4ca5ee4b")
bot_token = os.environ.get("5011062548:AAH6LCh3zCu_mIejfcQaT3v0uoKQRxPQXo4")
